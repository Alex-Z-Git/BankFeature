...
@pytest.mark.parametrize("our_card_data, excepted_card_data", [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
...
@pytest.mark.parametrize("wrong_time_data, excepted", [("2024/03/11T02:26:18.671407", "Введены некорректные параметры времени (ожидается 'YYYY-MM-DD')"),
